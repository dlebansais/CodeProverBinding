...
/// </summary>
public class ReferenceConstantExpression : ConstantExpression<ReferenceIndex>, IReferenceConstantExpression
{
    /// <summary>
    ...
    public ReferenceConstantExpression(Binder binder, ReferenceIndex value)
        : base(binder, value)
    {
